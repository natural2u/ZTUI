//
//  ZTUICycleScrollView.m
//
//  Created by MaPengzhen on 15-8-18.
//  Copyright (c) 2015年 MaPengzhen. All rights reserved.
//

#import "ZTUICycleScrollView.h"

#import "ZTUICycleScrollSubView.h"

@interface ZTUICycleScrollView() {

}
@end

@implementation ZTUICycleScrollView
...
- (void) initContent {
    ...
    rect.size.height = 30;
    _pageControl = [[ZTPageControlExt alloc] initWithFrame:rect];
...
- (void)setDataSource:(id <ZTUICycleScrollViewDataSource>)datasource {
...
- (void) addToCache:(ZTUICycleScrollSubView*) view {
...
- (void)getDisplayImagesWithCurpage:(NSInteger)page {
    ...
    ZTUICycleScrollSubView *preView = [_dataSource scrollView:self pageAtIndex:pre];
    if (!preView) {
        return;
    }
    ...
    ZTUICycleScrollSubView *centerView = [_dataSource scrollView:self pageAtIndex:page];
    if (!centerView) {
        return;
    }
    ...
    ZTUICycleScrollSubView *lastView = [_dataSource scrollView:self pageAtIndex:last];
    if (!lastView) {
        return;
    }
